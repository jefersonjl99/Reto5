 ...
 * @author jefer
 */
public class PanelModificacion extends Panel {
    ...
    public PanelModificacion(int Xi, int Yi, int Xf, int Yf) {
        super(Xi, Yi, Xf, Yf);
    ...
    private void inicializarComponentes() {
        ...
        anadirCaracteristicasBotones(botonModificar);
        botonModificar.setBounds(200, this.getHeight() / 2 - 10, 100, 20);
        ...
        informacionIngreso = new JLabel("<html>Ingrese los datos segun corresponda,<p> luego pulse en modificar:<html>");
